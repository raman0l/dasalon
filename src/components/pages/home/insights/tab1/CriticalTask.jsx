  ...
  return (
    <div className="w-full lg:px-6 md:px-5 px-4">
      ...
      <div className="flex gap-2 justify-between lg:py-6 py-4 max-[538px]:flex-col">
        ...
        >
          <SelectTrigger className="lg:w-[200px] w-[160px]">
        ...
        <div className="flex lg:gap-5 md:gap-3 gap-2 items-center flex-wrap">
          <div className="relative lg:w-[290px] md:w-[230px] w-[160px]">
            <Search
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[#D9DDE3] h-3 -h-3"
              size={18}
            />
            <input
              type="text"
          ...
          <div className="relative inline-block">
            <div
              ...
              className="flex items-center gap-2 border border-[#D9DDE3] 
               hover:border-[#B751FB] 
               focus:border-[#B751FB] 
               focus-visible:outline-none 
               focus-visible:ring-2 
               focus-visible:ring-[#B751FB]/50 
               rounded-md 
               lg:px-4 md:px-3 px-2 
               py-2 
               cursor-pointer 
               transition-colors"
              tabIndex={0} // 🔹 important: for keyboard + focus support
            >
              <FilterIcon className="h-3 w-3 text-[#A8A9AE]" />
            ...
            {showCalendar && (
              <div className="absolute mt-2 right-0 z-50 bg-white border rounded-md shadow-lg">
                <Calendar
                  mode="single"
                  selected={date}
                  onSelect={(day) => {
