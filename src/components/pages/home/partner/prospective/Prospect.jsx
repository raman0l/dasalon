      ...
      >
        ...
        <SheetContent className=" bg-white gap-0 h-screen">
          ...
          >
            ...
            >
              <Pragraph
                className="!text-[7px] font-semibold leading-[160%] tracking-[-0.145px] !text-[rgba(3,7,18,0.80)] py-[2px] px-2 rounded-2xl bg-[#F4888857] border-[#FF0000] border-1"
                title={"Prospect"}
              />
            </SheetTitle>
          </SheetHeader>
          <div className="overflow-auto pb-15 custom-scrollbar overflow-x-hidden">
            <div>
